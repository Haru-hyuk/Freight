...
export function ShipperDetailView({ shipperId }: Props) {
    ...
    <div className="min-h-screen space-y-5 bg-background text-foreground">
      <div className="space-y-3">
        <Button asChild type="button" variant="secondary" size="sm">
          <Link to="/users/shippers" className="inline-flex items-center gap-2">
        ...
        <div>
          <h1 className="text-2xl font-semibold">화주 상세</h1>
          <p className="text-sm text-foreground/70">기본 정보와 배송 기록을 확인합니다.</p>
        </div>
      </div>
